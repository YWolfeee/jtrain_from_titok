...
#PBS -S /bin/bash
#PBS -l select=1:ncpus=12:mem=90gb:ngpus=1:host=cvml05

config_name='titok_b512_4096_12'
model_type="transformer"
logit_head_type="gaussian_1"
rate_weight=0
tag="eval_stage1_use_encoder_mask"
...
WANDB_MODE=offline accelerate launch \
    ...
    scripts/eval_titok.py config=configs/training/stage1/${config_name}.yaml \
